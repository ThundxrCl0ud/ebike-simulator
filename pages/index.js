...
"Black", "White", "Gray", "Light Gray", "Dark Gray", "Red", "Dark Red", "Crimson", "Pink", "Light Pink", "Coral", "Orange", "Dark Orange", "Peach",
"Yellow", "Gold", "Light Yellow", "Lime", "Green", "Dark Green", "Olive", "Teal", "Cyan", "Light Blue", "Blue", "Dark Blue", "Navy", "Indigo",
"Purple", "Lavender", "Violet", "Brown", "Tan", "Beige", "Maroon", "Burgundy", "Sienna", "Chocolate", "Salmon", "Tomato", "Khaki", "Plum", "Orchid",
"Magenta", "Turquoise", "Aquamarine", "Sky Blue", "Steel Blue", "Slate Gray", "Moss Green", "Forest Green", "Mint", "Peacock Blue", "Cerulean",
"Electric Blue", "Azure", "Cobalt Blue", "Ruby Red", "Cherry Red", "Firebrick", "Pumpkin", "Sunflower", "Mustard", "Cream", "Ivory", "Snow",
"Charcoal", "Jet Black", "Ash Gray", "Rose", "Blush", "Mauve", "Periwinkle", "Lilac", "Eggplant", "Copper", "Bronze", "Steel", "Lead", "Platinum",
"Champagne", "Pear", "Lemon", "Apple Green", "Chartreuse", "Jade", "Sea Green", "Fern", "Olive Drab", "Sand", "Rust", "Copper Red", "Mahogany"
    ],
    Light: [
      ...
      "Almond", "Bubblegum Pink", "Baby Pink", "Fairy Tale", "Isabelline", "Tea Rose", "Light Brick", "Cameo Pink", "Piggy Pink", "Tiffany Blue",
      "Carolina Blue"
    ],
    Dark: [
      ...
      "Dark Chartreuse", "Dark Sea Green", "Dark Cyan", "Deep Teal", "Dark Aqua", "Midnight Teal", "Gunmetal", "Charcoal", "Onyx", "Jet Black",
    ...
    Matte: [
      ...
      "Matte Dark Taupe", "Matte Deep Teal", "Matte Dark Cyan", "Matte Dark Violet", "Matte Dark Magenta", "Matte Dark Orchid", "Matte Mulberry",
      "Matte Dark Burgundy", "Matte Deep Ruby", "Matte Dark Rose", "Matte Saddle Brown", "Matte Brown Sugar", "Matte Burnt Umber", "Matte Russet",
      "Matte Deep Amber", "Matte Bronze Olive", "Matte Olive Brown", "Matte Steel Gray", "Matte Dark Gray"
    ],
    Metallic: [
      ...
      "Metallic Maroon", "Metallic Chocolate", "Metallic Coffee", "Metallic Copper Red", "Metallic Burnt Umber", "Metallic Rust",
      "Metallic Bronze Red", "Metallic Dark Brown", "Metallic Tan", "Metallic Sand", "Metallic Wheat", "Metallic Beige", "Metallic Pearl",
      "Metallic Light Gray", "Metallic Silver Gray", "Metallic Dark Gray", "Metallic Charcoal", "Metallic Black", "Metallic Graphite Black",
      "Metallic Oil Slick"
    ],
    Neon: [
      ...
      "Neon Silver", "Neon Bronze", "Neon Crimson", "Neon Salmon", "Neon Violet", "Neon Indigo", "Neon Marigold", "Neon Chartreuse",
      ...
      "Neon Fluorescent Blue", "Neon Fluorescent Purple", "Neon Fluorescent Cyan", "Neon Fluorescent Magenta", "Neon Lime Green",
      "Neon Bright Lime", "Neon Bright Turquoise", "Neon Bright Mint", "Neon Bright Lavender", "Neon Bright Peach", "Neon Bright Coral",
      "Neon Bright Salmon", "Neon Bright Violet", "Neon Bright Indigo", "Neon Bright Maroon", "Neon Bright Olive", "Neon Bright Teal",
      "Neon Bright Silver", "Neon Bright Gold", "Neon Bright Bronze", "Neon Bright Copper", "Neon Bright Ruby", "Neon Bright Emerald",
      "Neon Bright Sapphire", "Neon Bright Topaz", "Neon Bright Amethyst", "Neon Bright Onyx", "Neon Bright Quartz", "Neon Bright Pearl",
      "Neon Bright Steel", "Neon Bright Ash", "Neon Bright Charcoal", "Neon Bright Smoke", "Neon Bright Cloud", "Neon Bright Sky",
      "Neon Bright Ocean", "Neon Bright Forest", "Neon Bright Jungle", "Neon Bright Grass", "Neon Bright Moss", "Neon Bright Leaf",
      "Neon Bright Pine", "Neon Bright Olive Drab", "Neon Bright Lime Punch", "Neon Bright Kiwi", "Neon Bright Aloe", "Neon Bright Shamrock",
      "Neon Bright Fern", "Neon Bright Basil", "Neon Bright Celadon", "Neon Bright Jade", "Neon Bright Lagoon", "Neon Bright Lagoon Blue",
      "Neon Bright Azure", "Neon Bright Cobalt", "Neon Bright Royal Blue", "Neon Bright Denim", "Neon Bright Navy", "Neon Bright Midnight",
      "Neon Bright Plum", "Neon Bright Orchid", "Neon Bright Lilac", "Neon Bright Heather", "Neon Bright Mauve", "Neon Bright Blush",
      "Neon Bright Rose", "Neon Bright Ruby Red", "Neon Bright Cherry", "Neon Bright Crimson", "Neon Bright Brick", "Neon Bright Rust",
      "Neon Bright Copper Red", "Neon Bright Burnt Orange", "Neon Bright Tangerine", "Neon Bright Sunset", "Neon Bright Amber", "Neon Bright Honey",
      "Neon Bright Saffron", "Neon Bright Mustard", "Neon Bright Lemon", "Neon Bright Citrus", "Neon Bright Banana", "Neon Bright Gold Rush"
    ],
    Flake: [
      ...
      "Sparkle Magenta", "Glitter Charcoal", "Flake Burgundy", "Metallic Rose Flake", "Pearl Champagne", "Sparkly Mint", "Candy Coral Flake",
...
function getColorButtonStyle(option) {
  ...
  "Metallic Champagne Pink": "#F1E7E6",
